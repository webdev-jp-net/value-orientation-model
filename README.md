...
#### ポイント算出方法
各軸に関連する変数の差分を、プロット座標とする。詳細は [matrix_drawing.md](./_llm-docs/spec/matrix_drawing.md) を参照。
...
- 可視化手法（例：マトリクス表示）は表現手段であり、モデルの本質ではない。詳細は [matrix_drawing.md](./_llm-docs/spec/matrix_drawing.md) を参照。
